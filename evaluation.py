...
# The path for sentences.json, which contain correct standard answer for each receipts
file_path_standard = 'D:\\UVA\\NLP\\NLP-Tiny-Project\\sentences.json' 
...
print(f"Overall cosine similarity: {overall_average:.4f}")
